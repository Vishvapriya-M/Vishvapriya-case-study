...
public class BloodBankController {
	...
	@PostMapping("/req")
	public String getForm(@RequestParam("reqType") String reqType, Model model) {
	...
	@PostMapping("/process")
	public String validateForm(@RequestParam("uname") String userName, @RequestParam("pwd") String pwd,
